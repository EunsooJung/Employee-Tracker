      ...
      db.query(
        ...
        err => {
          if (err) {
            ...
            console.log('Insert employee with manager success!');
            resolve();
          }
        }
      );
      ...
      db.query(
        ...
        err => {
          if (err) {
            ...
            console.log('Success insert employee !');
            resolve();
          }
        }
      );
  ...
  return new Promise((resolve, reject) => {
    ...
    db.query(query, [firstName, lastName, role.id], err => {
      if (err) {
        ...
        resolve('Success updated employee !');
      }
    });
  });
};
    ...
    if (managerID) {
      ...
      db.query(
        ...
        (err, results, fields) => {
          if (err) {
            ...
            resolve('Success updated employee with manager id !');
          }
        }
      );
    } else {
      ...
      db.query(query, [firstName, lastName], (err, results, fields) => {
        if (err) {
          ...
          resolve('Success updated employee with manager id null !');
        }
      });
    }
  });
